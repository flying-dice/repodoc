...
/**
 * The inline SVGs the board draws, and the wrapper that places them.
 *
 * They are inlined rather than linked because the webview's CSP allows no
 * remote resources, and wrapped in a flex span because a bare inline SVG picks
 * up a baseline gap that mis-aligns it against its label.
 *
 * MIRROR: `media/board.js` — `ICON` and `icon`.
 */
export const ICON = {
 ...
 * @returns {HTMLElement}
 */
export function Icon(markup, className) {
