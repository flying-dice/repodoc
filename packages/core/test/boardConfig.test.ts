...
describe('boardConfig.normalizeBoardConfig — columns', () => {
...
describe('boardConfig.normalizeBoardConfig — custom fields', () => {
...
describe('boardConfig.normalizeBoardConfig — column gates', () => {
